...
La valaur finale de la durée d'ensoleillement pour les données d'archive sera la somme des données de chaque paquet LOOP emis durant la période d'archivage.
